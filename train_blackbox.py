...
from dataset.dataset import SkinDataset, busiDataset, cmmdDataset, idridDataset, cmDataset, nctDataset, edemaDataset, siimDataset
...
if __name__ == '__main__':
    ...
    parser.add_option('--data-path', type='str', dest='data_path', 
            default='./dataset/', help='the path of the dataset')
